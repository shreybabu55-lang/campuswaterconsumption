...
import { Droplets, Mail, Lock, Loader, ShieldAlert, Cpu, Eye, EyeOff } from 'lucide-react';
import api from '../utils/api';
import { setAdminToken, setAdminUser, setActivePortal } from '../utils/auth';
            ...
            <div className="glass-card animate-fadeIn" style={{
                ...
                <div className="flex flex-col items-center" style={{ marginBottom: 'var(--spacing-xl)' }}>
                    ...
                    <h1 style={{ fontSize: 'var(--font-size-2xl)', fontWeight: 700, margin: 0 }}>
                        {isResetMode ? 'Admin Reset Password' : 'Admin Login'}
                    </h1>
